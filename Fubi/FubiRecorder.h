...
public:
	...
	bool startRecording(const std::string& fileName, const FubiUser* user, bool useFilteredData);
	...
	// Same for hands
	bool startRecording(const std::string& fileName, const FubiHand* hand, bool useFilteredData);
...
#endif
	void recordNextSkeletonFrame(const Fubi::TrackingData* data, int leftFingerCount, int rightFingerCount);
